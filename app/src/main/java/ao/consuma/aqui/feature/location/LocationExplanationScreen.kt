...
fun LocationExplanationScreen(
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.location_explanation_title),
                style = MaterialTheme.typography.headlineMedium,
                textAlign = TextAlign.Center
            )
            Spacer(modifier = Modifier.height(ConsumaSpacing.md))
            Text(
                text = stringResource(R.string.location_explanation_description),
            ...
            Spacer(modifier = Modifier.height(ConsumaSpacing.md))
            Text(
                text = stringResource(R.string.location_explanation_privacy),
        ...
        Column(
            ...
            ConsumaPrimaryButton(
                ...
                fullWidth = true,
                modifier = Modifier.testTag(NavigationTestTags.LOCATION_USE_CURRENT)
            )
            ConsumaSecondaryButton(
                text = stringResource(R.string.location_choose_manually),
                onClick = onChooseManually,
                fullWidth = true,
                modifier = Modifier.testTag(NavigationTestTags.LOCATION_CHOOSE_MANUALLY)
            )
            ConsumaTextButton(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .testTag(NavigationTestTags.LOCATION_SKIP)
            )
        }
    }
}
...
@Composable
private fun LocationExplanationScreenPreview() {
    ConsumaAquiTheme {
